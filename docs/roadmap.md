...
_Shipped 2026-06-05: sex→gender rename, Progress dashboard re-tier, body measurement units (cm / in) + Profile Body block, recovery detail chips, Progress time window (Week/Cycle/All), clearer nav icons, Profile Body trend chips (see Shipped)._
