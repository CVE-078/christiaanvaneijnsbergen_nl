...
| # | Feature | Notes |
|---|---------|-------|
| 1 | Adaptive missed-workout regeneration | "You missed Lower B, here's an adjusted week" instead of restart. High adherence value; sessions infra exists. Builds on the program/progression model just shipped. (inspired by: Fitbod) |
