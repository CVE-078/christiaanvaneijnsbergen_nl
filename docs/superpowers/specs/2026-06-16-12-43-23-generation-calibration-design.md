...
So a dumbbell goblet squat / RDL / split squat assigned 3-6 or 6-8 becomes 10-15. Barbell/machine/cable lifts, upper-body dumbbell presses/rows, and all isolations are untouched. Pure, deterministic, and a no-op on synthetic golden pools (their exercises are not dumbbell-tagged the same way; confirm goldens stay byte-identical, and if any churns, tighten the predicate).
