...
export const WORKOUTS: Record<WorkoutType, Workout> = {
    push: {
        ...
        exercises: [
            ...
            },
            {
                ...
                sets: '2–3',
                reps: 'To RIR',
                load: 'Bodyweight; add DB on back to progress',
    ...
    pull: {
        ...
        exercises: [
            ...
            },
            {
                ...
                sets: '3',
                reps: '10–14',
                load: '14–16kg per DB alternating',
    ...
    legs: {
        ...
        exercises: [
            ...
            {
                name: 'DB Leg Curl (lying on bench)',
                sets: '3',
                reps: '12–15',
