...
describe('templateMatchesEquipment', () => {
    ...
    it('rejects when user missing one', () => expect(templateMatchesEquipment(t, new Set(['dumbbells']))).toBe(false));
    it('matches exact set', () => expect(templateMatchesEquipment(t, new Set(['dumbbells', 'barbell']))).toBe(true));
