  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      ...
      >
        ...
        {isRateLimited && (
          <p role="alert" style={{ fontFamily: MONO, fontSize: '0.6875rem', letterSpacing: '0.04em', color: '#f97316', marginBottom: '1.25rem' }}>
            Too many attempts. Wait 15 minutes.
          </p>
        )}
        {isWrongPassword && !isRateLimited && (
          <p role="alert" style={{ fontFamily: MONO, fontSize: '0.6875rem', letterSpacing: '0.04em', color: '#f43f5e', marginBottom: '1.25rem' }}>
            Incorrect password.
          </p>
        )}
