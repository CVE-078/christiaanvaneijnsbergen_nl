  ...
  return (
    <div style={{ borderBottom: `1px solid ${BORDER}`, background: SURFACE, overflow: 'hidden' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 1rem' }}>
        <span style={{ fontFamily: MONO, fontSize: '0.625rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: done ? ACCENT : DIM }}>
          {done ? 'Go!' : 'Rest'}
        </span>
        <span style={{ fontFamily: MONO, fontSize: '1rem', fontWeight: 700, color: done ? ACCENT : '#fff', letterSpacing: '0.04em', minWidth: '2.75rem' }}>
          {fmt(remaining)}
        </span>
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          {!done && (
            <button
              ...
              style={{ fontFamily: MONO, fontSize: '0.625rem', letterSpacing: '0.06em', color: DIM, background: 'none', border: '1px solid #2a2a2a', borderRadius: '3px', padding: '0.2rem 0.4rem', cursor: 'pointer' }}
            >
              +30s
            </button>
          )}
          ...
          <button
            ...
            style={{ fontFamily: MONO, fontSize: '0.625rem', letterSpacing: '0.06em', color: '#444', background: 'none', border: 'none', cursor: 'pointer', padding: '0.2rem 0' }}
          >
            Skip
          </button>
        </div>
