            ...
            <div className="md:container mx-auto transition-all duration-400">
                ...
                <div className="absolute left-1/2 bottom-14 md:bottom-20 -translate-x-1/2">
                    <button
                        ...
                        className="inline-flex flex-row items-center text-primary border border-primary rounded-full relative whitespace-nowrap transition-all duration-400 py-2.5 px-6 md:py-4 hover:text-white group gap-4 cursor-pointer bg-transparent">
