...
const defaultProfile: Profile = { display_name: 'Test User', unit: 'kg', active_routine_id: null, onboarding_completed: false, goal_weight_kg: null };
...
describe('useProfile', () => {
    ...
    it('updateProfile calls mutate optimistically and calls the server action', async () => {
        ...
        expect(profileMutate).toHaveBeenCalledWith({ display_name: 'New Name', unit: 'lbs', active_routine_id: null, onboarding_completed: false, goal_weight_kg: null }, false);
